            ...
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <hr class="my-0"/>
                        <div class="mb-3">
                            <label for="userName" class="form-label">Name<span class="text-balance">*</span></label>
                            <input type="text" class="form-control" value="{{ old('name') }}" id="userName"
                                   name="name" required placeholder="Display Name"/>
                        </div>
                        <div class="mb-3">
                            <label for="userEmail" class="form-label">Email<span class="text-balance">*</span></label>
...
{{--                        </div>--}}
                        <div class="mb-3">
                            <label for="userRole" class="form-label">Role<span class="text-balance">*</span></label>
