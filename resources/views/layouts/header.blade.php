<nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
    ...
    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
            <!-- Visit Website -->
            <li class="nav-item navbar-dropdown dropdown-user  me-2 me-xl-0 mx-1">
                <a class="nav-lin hide-arrow" href="{{ config('app.url') }}" target="_blank">
                    <i class="ti ti-world ti-md"></i>
                    <span class="text-decoration-underline align-bottom">Visit Website</span>
                </a>
            </li>
            <!-- /Visit Website -->
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        <img src="{{ $authUser->avatar }}" alt class="h-auto rounded-circle" />
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                        <a class="dropdown-item" href="javascript:void(0);" onclick="HamkkeJsHelpers.submitLogoutForm()">
