                ...
                <div class="col-md-9 paddingR tab-content pt-0" id="v-pills-tabContent">
                    ...
                    <div class="article-div">
                        ...
                        <div class="container py-4">
                            <h2 class="font-weight-light text-center text-muted py-3">Replies</h2>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col py-2">
                                        <div class="card">
                                            <div class="card-body">
                                                <div
                                                    class="float-end text-muted">{{ $reply->created_at->format('D, M jS Y g:i A') }}</div>
                                                <p class="card-text">{!! $parsedReplyBody !!}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="post-box">
                                        <form action="{{ route('forum.posts.reply', [$forumPost]) }}" method="post"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" placeholder="type something" name="reply-body"
                                                          style="display: none;"
                                                          id="reply-content">{{ old('reply-body') }}</textarea>
                                            </div>
